const translations = {
  en: {
    ...
    formatGroupPortrait: 'Portrait & full screen',
    formatGroupSquare: 'Square',
    formatGroupLandscape: 'Landscape',
    formatHighResPortrait: 'High-res portrait',
    formatPortraitPost: 'Portrait post',
    formatTallPost: 'Tall post',
    formatFullScreen: 'Story / Reel / Post / Short',
    formatStandardPin: 'Standard Pin',
    formatSquarePost: 'Square post',
    formatLandscapePost: 'Landscape post',
  ...
  es: {
    ...
    formatGroupPortrait: 'Vertical y pantalla completa',
    formatGroupSquare: 'Cuadrado',
    formatGroupLandscape: 'Horizontal',
    formatHighResPortrait: 'Vertical en alta resolución',
    formatPortraitPost: 'Publicación vertical',
    formatTallPost: 'Publicación alta',
    formatFullScreen: 'Historia / reel / publicación / short',
    formatStandardPin: 'Pin estándar',
    formatSquarePost: 'Publicación cuadrada',
    formatLandscapePost: 'Publicación horizontal',
    formatThumbnail: 'Miniatura',
